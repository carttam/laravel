<div class="col-12 col-md-1 col-lg-2 pt-2 pt-lg-5 ps-sm-0">
    <div class="nav flex-column nav-pills me-lg-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#role_list" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false"><span
                class="d-md-none d-lg-inline">لیست نقش ها</span> <i class="bi bi-person-bounding-box"></i> </button>
